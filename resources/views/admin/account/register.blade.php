            ...
            <form action="" class="mt-4">
                <div class="form-group ">
                    <div class="mb-2 mt-2 text-[17px]">
                        <label for="" class="block mb-2">Họ tên người đăng ký</label>
                        <input type="text" name="full_name" placeholder="Họ tên người đăng ký"

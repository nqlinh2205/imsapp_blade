...
@section('content')
    <main class=" pr-4 pt-4">
        ...
        <div class="flex justify-between  min-w-[1122px]">
            <h1 class="font-roboto text-[25px] font-bold">Danh sách đơn hàng</h1>
        ...
        <div class="mt-4 min-w-[1122px] overflow-x-scroll  rounded-t-[10px] shadow-full">
            <table class="w-full text-center ">
                <thead>
                    ...
                    <th>Mã đơn hàng</th>
                    <th class="w-1/6">Tình trạng</th>
                    <th class="w-1/6">Tổng tiền (đ)</th>
                ...
                <tbody>
                    @for ($i = 0; $i < 2; $i++)
                        <tr>
                            ...
                            <td class="underline text-left px-4">ID123456</td>
                            <td class="">Chờ thanh toán</td>
                            <td class="text-right px-4">458.000</td>

...
@section('content')
    <main class=" pr-4 pt-4">
        ...
        <div class="flex justify-between  min-w-[1122px]">
            <h1 class="font-roboto text-[25px] font-bold">Quản lý tên miền</h1>
        ...
        <div class="mt-4 min-w-[1122px] overflow-x-scroll  rounded-t-[10px] shadow-full">
            <table class="w-full text-center ">
                <thead>
                    <th class="border-l-transparent">ID</th>
                    <th>Tên miền/Khách hàng</th>
                    <th>Dns1</th>
                    <th>Dns2</th>
                    <th>Ngày đăng ký</th>
                    <th>Ngày hết hạn</th>
                    <th>Trạng thái EPP</th>
                    <th class="border-r-transparent">Chức năng</th>
                </thead>
                <tbody>
                    @for ($i = 0; $i < 4; $i++)
                        <tr>
                            <td class="border-l-transparent">123456</td>
                            <td><a href="" class="text-[#0771B1] underline">duhochongphuc.com</a></td>
                            <td>ns1.dns.net.vn</td>
                            <td>ns2dns.net.vn</td>
                            <td>28/08/2022</td>
                            <td>28/08/2023</td>
                            <td>clientTransferProhibited</td>
                            <td class="border-r-transparent">
                                <button class="bg-[#49D3F0] text-white rounded-[5px] py-2 px-6 ">Chức năng</button>
                            </td>
                        </tr>
                    @endfor

...
@section('content')
    <main class=" pr-4 pt-4">
        ...
        <div class="min-w-[1122px]">
            <h1 class="font-roboto text-[25px] font-bold">Bản khai tên miền</h1>
           
        </div>
        {{-- lọc tìm kiếm --}}
        <div class="rounded-[5px] shadow-full flex items-center mt-4 py-1 font-body text-[17px]">
            <button class=" flex items-center pl-10 py-4 space-x-3" data-dropdown-toggle="dropdown" id="dropdownDefault">
                <p class="text-[#0771B1]">Bản khai</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="11.669" height="7.573" viewBox="0 0 11.669 7.573">
                    <path id="Path_2303-2" data-name="Path 2303-2" d="M160,411.345l7.573-5.834L160,399.676Z"
                        transform="translate(411.345 -160) rotate(90)" fill="#0771B1" />
                </svg>
            </button>
            <button class=" flex items-center px-12 py-4 space-x-3" data-dropdown-toggle="dropdown"
                id="dropdownDefault">
        ...
        <div class="mt-4 min-w-[1122px] overflow-x-scroll  rounded-t-[10px] shadow-full">
            <table class="w-full text-center ">
                <thead>
                    ...
                    <th class="w-1/5">Tên miền</th>
                    <th>Tình trạng</th>
                    <th>Tải về</th>
                    <th>Tải lên</th>
                    <th class="w-1/5">Ngày ký</th>
                ...
                <tbody>
                    @for ($i = 0; $i < 4; $i++)
                        <tr>
                            ...
                            <td class="text-left px-4"><a href="" class="text-[#0771B1] underline ">duhochongphuc.com</a></td>
                            <td>Chưa nộp</td>
                            <td>
                                <span class="inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15.972" height="16" viewBox="0 0 15.972 16">
                                        <g id="Group_21756" data-name="Group 21756" transform="translate(0 0)">
                                          <path id="Path_61267" data-name="Path 61267" d="M-362.489,192a.914.914,0,0,1,.692.648,1.5,1.5,0,0,1,.036.371q0,4.077,0,8.154v.232c.072-.069.114-.107.154-.147q.937-.939,1.875-1.877a.851.851,0,0,1,.874-.232.834.834,0,0,1,.622.655.885.885,0,0,1-.273.866q-.989.987-1.974,1.977-.733.734-1.466,1.469a.9.9,0,0,1-1.394,0q-1.715-1.717-3.428-3.435a.9.9,0,0,1-.093-1.261.882.882,0,0,1,1.314-.028c.624.619,1.243,1.244,1.864,1.866.04.04.081.078.154.147v-.231q0-4.092,0-8.185a.89.89,0,0,1,.7-.97A.107.107,0,0,0-362.8,192Z" transform="translate(370.632 -192)"/>
                                          <path id="Path_61268" data-name="Path 61268" d="M-449.1,453.295a9.064,9.064,0,0,1-.973-.256,3.534,3.534,0,0,1-2.238-3.225c0-.318,0-.635,0-.953a.892.892,0,0,1,.884-.9.9.9,0,0,1,.891.9,10.708,10.708,0,0,0,.037,1.2,1.723,1.723,0,0,0,1.667,1.454c1.377.012,2.754,0,4.131.005,1.59,0,3.18,0,4.77,0a1.748,1.748,0,0,0,1.76-1.367,3.845,3.845,0,0,0,.051-.7c.008-.208,0-.417,0-.625a.883.883,0,0,1,.765-.853.882.882,0,0,1,.963.6l.046.131v1.375a.669.669,0,0,0-.029.1,3.55,3.55,0,0,1-2.579,2.988c-.2.053-.4.086-.6.128Z" transform="translate(452.312 -437.295)"/>
                                        </g>
                                      </svg>
                                </span>
                            </td>
                            <td>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="15.972" height="16" viewBox="0 0 15.972 16">
                                    <g id="Group_21757" data-name="Group 21757" transform="translate(0 0)">
                                      <path id="Path_61269" data-name="Path 61269" d="M-833.912,204.448a.914.914,0,0,1-.692-.648,1.5,1.5,0,0,1-.036-.371q0-4.077,0-8.154v-.232c-.072.069-.114.107-.154.147q-.937.939-1.875,1.877a.851.851,0,0,1-.874.232.834.834,0,0,1-.622-.655.884.884,0,0,1,.273-.866q.989-.987,1.974-1.977.733-.735,1.466-1.469a.9.9,0,0,1,1.394,0q1.715,1.717,3.428,3.435a.9.9,0,0,1,.093,1.261.883.883,0,0,1-1.314.028c-.624-.619-1.243-1.244-1.864-1.866-.04-.04-.081-.078-.154-.147v.231q0,4.092,0,8.185a.89.89,0,0,1-.7.97.11.11,0,0,0-.025.018Z" transform="translate(841.743 -192)"/>
                                      <path id="Path_61270" data-name="Path 61270" d="M-920.208,453.295a9.062,9.062,0,0,1-.973-.256,3.534,3.534,0,0,1-2.238-3.225c0-.318,0-.635,0-.953a.892.892,0,0,1,.884-.9.9.9,0,0,1,.891.9,10.737,10.737,0,0,0,.037,1.2,1.723,1.723,0,0,0,1.667,1.454c1.377.012,2.754,0,4.131.005,1.59,0,3.18,0,4.77,0a1.748,1.748,0,0,0,1.76-1.367,3.84,3.84,0,0,0,.051-.7c.008-.208,0-.417,0-.625a.883.883,0,0,1,.765-.853.882.882,0,0,1,.963.6l.046.131v1.375a.655.655,0,0,0-.028.1,3.55,3.55,0,0,1-2.579,2.988c-.2.053-.4.086-.6.128Z" transform="translate(923.423 -437.295)"/>
                                    </g>
                                  </svg>
                                </span>
                            ...
                            <td class="border-r-transparent">GHI CHÚ</td>
            ...
            {{-- <div class="text-center py-4 rounded-b-[10px]">

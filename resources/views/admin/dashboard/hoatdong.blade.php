...
@section('content')
    <main class=" pr-4 pt-4">
        ...
        <div class="flex justify-between  min-w-[1122px]">
            <h1 class="font-roboto text-[25px] font-bold">Danh sách hoạt động</h1>
        ...
        <div class="rounded-[5px] shadow-full flex items-center mt-4 space-x-10">
            <form action="" class="w-full py-4 px-4">
        ...
        <div class="mt-4 min-w-[1122px] overflow-x-scroll  rounded-t-[10px] shadow-full">
            <table class="w-full text-center font-body ">
                <thead>
                ...
                <tbody class="text-[15px]">
                    @for ($i = 0; $i < 8; $i++)
                        <tr>
                            ...
                            <td>28/08/2022   11:06:06</td>
                            <td >LOGIN</td>
                            <td></td>
                            <td>ACCOUNT</td>
                            <td>Đăng nhập thành công</td>
                            <td class="border-r-transparent">
                                <p class="text-[14px] text-[#0771B1]">Thành công</p>
                            </td>
                        </tr>
                    @endfor

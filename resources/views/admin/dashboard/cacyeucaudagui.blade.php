...
@section('content')
    <main class=" pr-4 pt-4">
        ...
        <div class="flex justify-between  min-w-[1122px]">
            <h1 class="font-roboto text-[25px] font-bold">Yêu cầu đã gửi</h1>
            <div class="flex space-x-10">
                ...
                <div class="flex items-center font-body text-[17px]">
                    ...
                    <button class="bg-[#49D3F0] text-white rounded-[5px] py-2 px-6 ml-4">Tạo yêu cầu</button>
                </div>
            </div>
        </div>
        {{-- lọc tìm kiếm --}}
        ...
        <div class="mt-4 min-w-[1122px] overflow-x-scroll  rounded-t-[10px] shadow-full">
            <table class="w-full text-center ">
                <thead>
                    ...
                    <th class="border-r-transparent">Trạng thái</th>
                </thead>
                <tbody>
                    @for ($i = 0; $i < 8; $i++)
                        <tr>
                            ...
                            <td>123456</td>
                            <td class="text-left "><a href="" class="underline px-4 ">Hỗ trợ Hosting thietkewebsite.info</a></td>
                            <td class="text-left "><a href="" class="underline px-4 ">Xem chi tiết</a></td>
                            <td>28/08/2023   11:06:06</td>
                            <td>28/08/2023   11:06:06</td>
